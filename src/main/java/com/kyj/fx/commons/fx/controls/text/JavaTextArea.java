...
public class JavaTextArea extends BorderPane {
	...
	private GargoyleCodeArea codeArea;
	...
	private static final ExecutorService executor = ExecutorDemons.getGargoyleSystemExecutorSerivce(); // .newSingleThreadExecutor("GARGOYLE-JAVA-STYLE");
	...
	public JavaTextArea(String content) {
		...
		codeArea = new GargoyleCodeArea(content);
...
//		this.codeArea.selectRange(0, 0);
	...
	public ObservableValue<String> contentProperty() {
		return codeHelperDeligator.contentProperty();
	}
