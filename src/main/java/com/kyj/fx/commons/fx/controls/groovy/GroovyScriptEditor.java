 ...
 *******************************/
package com.kyj.fx.commons.fx.controls.groovy;
...
import com.kyj.fx.commons.fx.controls.text.SqlKeywords;
 ...
 *
 */
public class GroovyScriptEditor extends BorderPane {
	...
	private static String[] KEYWORDS = new String[] { "def", "abstract", "assert", "boolean", "break", "byte", "case", "catch", "char",
	...
	public GroovyScriptEditor(String content) {
