 ...
 *	패키지   : com.kyj.fx.commons.fx.controls.groovy
 *	작성일   : 2019. 2. 19.
 *	작성자   : KYJ (callakrsos@naver.com)
 *******************************/
package com.kyj.fx.commons.fx.controls.jython;
 ...
 *
 */
public class JythonScriptEditor extends BorderPane {
	...
	private static Logger LOGGER = LoggerFactory.getLogger(JythonScriptEditor.class);

	private static String[] KEYWORDS = new String[] {"and", "assert" , "break", "class" , "continue" , "def" , "del", "elif"
				, "else" , "except" , "exec" , "finally" , "for" , "from" , "global" , "or" , "pass" , "print" , "raise", "return" , "try" , "while" , "with" , "yield" ,
				"import"};
...
//	private static final String COMMENT_PATTERN = "//[^\n]*" + "|" + "/\\*(.|\\R)*?\\*/";
	...
	public JythonScriptEditor() {
		this("");
	}

	public JythonScriptEditor(String content) {
		...
		this.getStylesheets().add(NashronScriptEditor.class.getResource("keywords.css").toExternalForm());
	...
	public ObservableList<Paragraph<Collection<String>, String, Collection<String>>> getParagraphs() {
	...
	public String getSelectedText() {
		// codeArea.setShowCaret(org.fxmisc.richtext.Caret.CaretVisibility.ON);
	...
	public CaretSelectionBind<Collection<String>, String, Collection<String>> getCaretSelectionBind() {
		return codeArea.getCaretSelectionBind();
	}
	...
	public void replaceText(IndexRange range, String text) {
		codeArea.replaceText(range, text);
	}
}
